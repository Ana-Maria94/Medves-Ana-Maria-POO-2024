...
public:
    Carte(char* autor1, char* editura1, unsigned anul_aparitie1, unsigned vechime1)
    {
        strcpy_s(autor, 20, autor1);
        strcpy_s(editura, 20, editura1);
        an_aparitie = anul_aparitie1;
        vechime = vechime1;
    }
...
int main()
{
    ...
    Carti* carti = new Carti[nr_carti];
    ...
    for (size_t i = 0; i < nr_carti; i++)
    {
        ...
        cout << "Introduceti vechimea cartii " << i + 1 << endl;
        unsigned vechime;
    ...
    cout << "Afisati detaliile carti: " << endl;
